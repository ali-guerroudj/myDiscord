...
channel1 = Channel("Ali", True, False)
chat_window1 = ChatWindow(channel1, '127.0.0.1', 25565, "Ali")  # Remplacez par les informations de votre serveur et le nom de l'expéditeur
