...
class Inscription:
    ...
    def run(self):
        ...
        while launched:
            ...
            first_name_label = self.font.render("first name:", True, self.NOIR)
            self.window_surface.blit(first_name_label, (self.carré_x + 50, self.carré_y + 50))
            last_name_label = self.font.render("last name:", True, self.NOIR)
            ...
            mdp_label = self.font.render("password:", True, self.NOIR)
